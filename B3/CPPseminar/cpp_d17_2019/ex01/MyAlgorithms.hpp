...
{
        std::rotate(container.begin(), container.begin() + nbShift, container
        .end());
}
...
{
        std::merge(container1.begin(), container1.end(), container2.begin(),
            container2.end(), containerToFill.begin());
}
